var config = {
    teams: {
        dataScrubbers: {
            ...
            acceptedListInt: 0, //This is the iterator for accepted lists. 0 will get most current accepted list and 1 would get second.
            path: '.\\Files\\CTLDA\\DataScrubbers\\'
        },
        noJS: {
            teamName: 'NoJs',
            key: '68b96eeaad12e1cd6c22742f48289557',
